  ...
  return (
    <div className="h-fit">
      <div className="bg-linear-to-r from-blue-700 to-teal-500 flex flex-col justify-between items-center gap-8 shadow-2xl">
        <div className="px-12 mt-4 w-full flex flex-col justify-center items-center py-8 gap-8">
          <h1 className="text-white/90 text-4xl font-bold font-headingXXL text-center">
            Website Design and Development
          </h1>
          <p className="text-white/70 text-lg font-title text-left md:text-center">
      ...
      <div className="flex flex-col gap-12 py-16 justify-center items-center w-full">
        <div className="text-4xl text-blue-800 px-6 text-center">
        ...
        <div className="flex flex-col md:flex-row gap-6 md:gap-8">
          <Card_02
            ...
            title={"fugiat aliqua"}
            desc={
              "Qui id consectetur pariatur velit ea laboris id culpa labore elit quis elit nostrud et do et veniam fugiat aliqua."
            }
          />
          <Card_02
      ...
      <div className="flex justify-center items-center bg-linear-to-r from-blue-700 to-teal-500 py-12 px-6">
        <SectionTemplate_01
          sectionTitle={"Labore consequat et proident"}
          sectionDesc={
      ...
      <div className="flex flex-col gap-16 justify-center items-center py-16">
        <div className="px-8 text-center text-3xl text-blue-700">
        ...
        <div className="flex flex-col gap-8 md:flex-row justify-center items-center">
          ...
          <img
            className="h-[600px] md:h-[400px] lg:h-[600px]"
